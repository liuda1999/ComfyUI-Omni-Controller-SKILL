...
SEG2_LASTFRAME = "c5_v14_seg2_lastframe_1784696380.png"
...
def build_seg3():
    return {
        ...
        "video_combine": {"class_type": "VHS_VideoCombine", "inputs": {
            ...
            "filename_prefix": f"c5_v14_seg3_{int(time.time())}",
...
def main():
    ...
    print("\n[拼接] ffmpeg合并3段")
    video_paths = [
        "E:/comfyui-cli/output/c5_v14_seg1_1784695828_00001.mp4",
        "E:/comfyui-cli/output/c5_v14_seg2_1784696140_00001.mp4",
        seg3_video
    ]
    inputs = []
    ...
    merged_path = "E:/comfyui-cli/output/c5_v14_merged_final.mp4"
    cmd = ["ffmpeg", "-y"] + inputs + [
        "-filter_complex", "[0:v][1:v][2:v]concat=n=3:v=1:a=0[outv]",
        "-map", "[outv]", "-c:v", "libx264", "-crf", "14",
        "-pix_fmt", "yuv420p10le", "-r", "24", merged_path
    ]
