...
SEG2_LASTFRAME = "c5_v12_seg2_lastframe_1784666394.png"
SEG1_VIDEO = "E:/comfyui-cli/output/c5_v12_seg1_1784665984_00001.mp4"
SEG2_VIDEO = "E:/comfyui-cli/output/c5_v12_seg2_1784666213_00001.mp4"
...
def build_seg3_workflow():
    return {
        ...
        "video_combine": {"class_type": "VHS_VideoCombine", "inputs": {
            ...
            "filename_prefix": f"c5_v12_seg3_{int(time.time())}",
...
def main():
    ...
    print(f"  [段3] 完成! {time.time()-t0:.0f}秒, {os.path.getsize(seg3_video)/1048576:.2f}MB")
    print(f"  段3视频: {seg3_video}")

    # 拼接3段
    print("\n[拼接] ffmpeg合并3段")
    video_paths = [SEG1_VIDEO, SEG2_VIDEO, seg3_video]
    ...
    if os.path.exists(merged_path):
        ...
        for i, vp in enumerate(video_paths, 1):
            print(f"  段{i}(3.4秒): {vp} ({os.path.getsize(vp)/1048576:.2f}MB)")
