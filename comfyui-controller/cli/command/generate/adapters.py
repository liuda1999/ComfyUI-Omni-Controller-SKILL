...
from cli.command.generate.client import ApiError
from cli.command.generate.schema import FlagDef
...
def _gemini_decode_sync(body: dict, download: str, request_id: str) -> list[Path]:
    ...
    from cli.command.generate import output
...
def _seedance_image_url(value: str, api_key: str) -> str:
    ...
    if value.startswith(("http://", "https://", "data:")):
        return value
    from cli.command.generate import upload
