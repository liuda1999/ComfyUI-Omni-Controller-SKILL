...
from cli import constants, logging_utils, utils
from cli.config_manager import ConfigManager
from cli.utils import singleton
...
class WorkspaceManager:
    ...
    def scan_dir(self):
        ...
        logging_utils.info(f"Scanning directory: {self.workspace_path}")
        model_files = []
    ...
    def fill_print_table(self):
        ...
        from cli.command.custom_nodes.cm_cli_util import resolve_manager_gui_mode
